...
export default (variables /* : * */ = variable) => {
  ...
  const headerTheme = {
      ...
      "NativeBase.Button": {
        ...
        ".transparent": {
          ...
          "NativeBase.Text": {
            ...
            paddingLeft: platform === PLATFORM.IOS ? 2 : 5,
            paddingRight: platform === PLATFORM.IOS ? undefined : 10,
          },
          backgroundColor: "transparent",
          borderColor: null,
          elevation: 0,
        ...
        paddingLeft: platform === PLATFORM.IOS ? 4 : 8,
      },
      flex: platform === PLATFORM.IOS ? 1 : 0.4,
      alignSelf: "center",
      alignItems: "flex-start",
    },
    "NativeBase.Body": {
      flex: 1,
      alignItems: platform === PLATFORM.IOS ? "center" : "flex-start",
      alignSelf: "center",
      "NativeBase.Segment": {
        borderWidth: 0,
        alignSelf: "flex-end",
      ...
      "NativeBase.Button": {
        ...
        ".transparent": {
          ...
          "NativeBase.Text": {
            ...
            fontSize: platform === PLATFORM.IOS ? 17 : 14,
            top: platform === PLATFORM.IOS ? 1 : -1.5,
            paddingRight: platform === PLATFORM.IOS ? 0 : undefined,
          },
          backgroundColor: "transparent",
          borderColor: null,
          elevation: 0,
    ...
    paddingLeft: platform === PLATFORM.IOS ? 6 : 10,
    paddingRight: 10,
    justifyContent: "center",
