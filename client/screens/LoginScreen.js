...
const LoginScreen = (props) => {
  ...
  return (
    ...
    <View testID="Tagline" style={styles.slide2}>
      <ImageBackground source={gradientBkgd} style={styles.bkgdImg}>
        <Text style={styles.desc}>Set goals for exercise, eating healthy, productivity, and so much more!</Text>
      </ImageBackground>
    </View>
    <View testID="Info" style={styles.slide3}>
      <ImageBackground source={gradientBkgd} style={styles.bkgdImg}>
        <Text style={styles.desc}>Connect with peers and share your activities!</Text>
        <Text style={styles.desc}>Gain points to redeem for cool prizes!</Text>
        <Button onPress={signInWithGoogle} style={{alignItems: "center", justifyContent: "center" }}>
